...
#ifndef TIKI_TEST_SWIFT_H
#define TIKI_TEST_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Tiki_Test",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9Tiki_Test11AppDelegate")
...
SWIFT_CLASS("_TtC9Tiki_Test10HeaderView")
...
SWIFT_CLASS("_TtC9Tiki_Test10HotKeyCell")
@interface HotKeyCell : UICollectionViewCell
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified previewImageView;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified hotKeyLabel;
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified containerLabelView;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC9Tiki_Test21HotKeysViewController")
@interface HotKeysViewController : UIViewController
...
@interface HotKeysViewController (SWIFT_EXTENSION(Tiki_Test)) <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
SWIFT_CLASS("_TtC9Tiki_Test21HotKeysViewModelTests")
@interface HotKeysViewModelTests : XCTestCase
- (void)setUp;
- (void)tearDown;
- (void)testFetchHotKeysSuccess;
- (void)testFetchHotKeysFailure;
...
SWIFT_CLASS("_TtC9Tiki_Test13SceneDelegate")
